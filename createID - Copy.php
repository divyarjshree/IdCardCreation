				...
				<form action="createID.php" method="post">
				 ...
				 <table id="myTable" class="table table-bordered table-hover table-striped">
                            ...
                            <tbody>
								...
								$slno = 1;
                                $query = mysqli_query($connection, "SELECT * FROM request_idcard INNER JOIN design_patterns ON request_idcard.stu_year = design_patterns.desg_yearwise ORDER BY request_idcard.Req_id ASC");
                                ...
                                while ($row = mysqli_fetch_array($query)) {
									...
									print '<td><button type="submit" class="btn btn-warning" name="update" value='.$row['Req_id'].'>Create</button></td>'; 
